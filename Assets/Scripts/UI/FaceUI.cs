...
namespace UI
{
    public class FaceUI : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        public Guid guid;
        ...
        public FaceUI Populate(Guid _guid, Action<Guid, bool> _onClickCallback, Action<Guid, string> _renameCallback)
        {
            guid = _guid;
